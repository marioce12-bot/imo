...
export default function Home() {
  return (
    <main className="landing">
      ...
      <form className="glass-search wrap" action="/explorer" method="get" aria-label="Rechercher un logement"><div className="search-heading"><span className="search-icon">⌕</span><div><small>Je cherche un logement à</small><strong>Où allez-vous ?</strong></div></div><label><span>Arrivée</span><input name="arrivee" type="date" /></label><label><span>Départ</span><input name="depart" type="date" /></label><label><span>Voyageurs</span><select name="voyageurs" defaultValue="2"><option value="1">1 voyageur</option><option value="2">2 voyageurs</option><option value="3">3 voyageurs</option><option value="4">4 voyageurs</option></select></label><button type="submit">Rechercher <span>↗</span></button></form>
