...
const properties: Property[] = [
  { id: 1, title: "Appartement lumineux avec vue sur la marina", city: "Cotonou", neighborhood: "Fidjrossè", type: "Appartement", price: 28000, bedrooms: 2, guests: 4, rating: 4.9, verified: true, image: "Maison contemporaine", tone: "explorer-image-1" },
  { id: 2, title: "Maison paisible entre jardin et océan", city: "Ouidah", neighborhood: "Centre", type: "Maison", price: 22000, bedrooms: 3, guests: 6, rating: 4.8, verified: true, image: "Maison jardin", tone: "explorer-image-2" },
  { id: 3, title: "Studio central, tout à pied", city: "Porto-Novo", neighborhood: "Ouando", type: "Studio", price: 18000, bedrooms: 1, guests: 2, rating: 4.7, verified: false, image: "Studio central", tone: "explorer-image-3" },
  { id: 4, title: "Villa familiale avec piscine privée", city: "Abomey-Calavi", neighborhood: "Arconville", type: "Villa", price: 45000, bedrooms: 4, guests: 8, rating: 4.9, verified: true, image: "Villa piscine", tone: "explorer-image-4" },
  { id: 5, title: "Deux pièces calme proche des commerces", city: "Cotonou", neighborhood: "Haie Vive", type: "Appartement", price: 32000, bedrooms: 1, guests: 3, rating: 4.6, verified: true, image: "Appartement calme", tone: "explorer-image-5" },
  { id: 6, title: "Escapade au bord du lac", city: "Ganvié", neighborhood: "Lac Nokoué", type: "Maison", price: 25000, bedrooms: 2, guests: 4, rating: 4.8, verified: false, image: "Maison sur le lac", tone: "explorer-image-6" },
];
