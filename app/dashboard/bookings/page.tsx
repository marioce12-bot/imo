...
export default function BookingsPage() {
  ...
  if (!authenticated) return <section className="auth-required"><div className="auth-required-icon">▣</div><h1>Vos séjours au même endroit.</h1><Link className="btn btn-ink" href="/auth?mode=login">Se connecter</Link><Link className="auth-required-link" href="/explorer">Explorer les logements →</Link></section>;
